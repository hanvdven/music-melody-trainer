            ...
            <div style={{
                ...
                <div style={{ position: 'absolute', left: 0, top: '50%', transform: 'translateY(-50%)' }}>
                    {renderButton(
                        ...
                        noteColoringMode === 'none' ? 'NO COLOR' : noteColoringMode === 'tonic_scale_keys' ? 'TONICS' : noteColoringMode === 'chords' ? 'CHORDS' : noteColoringMode === 'scale' ? 'SCALE' : noteColoringMode === 'subtle-chroma' ? 'SUBTLE CHROMA' : 'CHROMATONE',
                        () => {
