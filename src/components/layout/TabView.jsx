...
const TabView = ({
    ...
    activeClef,
    handleInputTestNote,
    // #990: a STABLE ref holding a function that returns the currently-expected treble note(s)
    // (input-test mode) OR currently-hittable note(s) (RPG combat) — read fresh, at note-on time,
