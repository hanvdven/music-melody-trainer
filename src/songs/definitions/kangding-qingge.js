// Kangding qingge — score data lives in the sibling JSON so the pure note/lyric/chord arrays stay
// separate from any JS-only fields (same split as happyBirthday.js).
//
// AUTO-GENERATED from src/songs/abc/kangding-qingge.abc by `npm run abc:song` (#871). Re-run the script rather
...
import data from '../data/kangding-qingge.json';
